...
\centering EECS 230 Deep Learning, Final Project Report
...
\begin{abstract}
Up to 8 pages excluding references for the final project report. The report should have at least 5 pages excluding references. We use Latex template for International Conference on Machine Learning (ICML).
\end{abstract}
